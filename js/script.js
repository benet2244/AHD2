...
const contenedorDuplicado = document.getElementById("contenedorDuplicado");
const listaDuplicada = listaOriginal.cloneNode(true);

contenedorDuplicado.appendChild(listaDuplicada);

listaDuplicada.classList.add("lista-duplicada");

const elementosDuplicados = listaDuplicada.getElementsByTagName("li");
if (elementosDuplicados.length > 0) {
    elementosDuplicados[0].className = "resaltado";
    elementosDuplicados[2].classList.add("resaltado"); 
}